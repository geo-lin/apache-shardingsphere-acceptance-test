    ...
    public static Map<String, InstanceConfiguration> getZooKeeperConfiguration(String overwrite, ShardingType shardingType) {
        ...
        switch (shardingType) {
            ...
            case SHARDING_ENCRYPT:
                instanceConfigurationMap.put("orchestration-sharding-encrypt-data-source", result);
                break;
            case SHARDING_MASTER_SLAVE_ENCRYPT:
                instanceConfigurationMap.put("orchestration-sharding-ms-encrypt-data-source", result);
                break;
        }
