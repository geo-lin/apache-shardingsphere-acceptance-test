...
public class LocalShardingEncryptConfiguration implements ExampleConfiguration {
    ...
    public DataSource getDataSource() throws SQLException {
        return OrchestrationEncryptDataSourceFactory.createDataSource(DataSourceUtil.createDataSource("demo_ds", DatabaseType.POSTGRESQL), getEncryptRuleConfiguration(), new Properties(), getOrchestrationConfiguration());
    }
